...
interface FolderComponentProps {
  tabs: Tab[];
  defaultValue?: { [key: string]: CheckboxOption[] };
}
...
const FolderComponent: React.FC<FolderComponentProps> = ({ tabs, defaultValue = {} }) => {
  ...
  const [selectedCheckboxes, setSelectedCheckboxes] = useState<{ [key: string]: CheckboxOption[] }>(
    defaultValue,
  ); // Object to store selected checkboxes for each tab
