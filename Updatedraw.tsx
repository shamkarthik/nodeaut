...
import { Drawer, Checkbox, Row, Col } from 'antd';
    ...
    <>
      ...
      <Drawer title="Folder" visible={visible} onClose={onClose} width={600}>
        <Row gutter={16}>
          ...
          <Col span={12}>
            <Checkbox.Group
              value={getSelectedCheckboxesForTab().map((checkbox) => checkbox.value)}
              onChange={(checkedValues) => handleCheckboxChange(activeTab, checkedValues)}
            >
              {renderCheckboxList()}
            </Checkbox.Group>
          </Col>
